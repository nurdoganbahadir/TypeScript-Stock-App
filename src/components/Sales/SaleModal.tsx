...
const SaleModal: React.FC<SalesProps> = ({
  open,
  handleClose,
  data,
  setData,
  ...
  const { products, brands } = useSelector((state: RootState) => state.stock);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (data?._id) {
      ...
      updateStock("sales", submitData); // Güncelleme işlemi
    } else {
      postStock("sales", submitData); // Ekleme işlemi
    }
